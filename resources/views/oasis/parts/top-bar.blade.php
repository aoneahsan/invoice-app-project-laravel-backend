<div class="z-w-full z-clearfix">
    ...
    <div class="z-text-center z-w-60per z-mx-p5rem z-float-left">
        <h1>THE OASIS</h1>
        <h3 class="z-font-normal z-mt-1rem">A PROJECT BY</h3>
        <h2 class="z-mt-p5rem">HAFIZ ESTATE & DEVELOPERS</h2>
        <h3 class="z-font-normal z-mt-p5rem">MAIN BARKI ROAD, LAHORE</h3>
    </div>
